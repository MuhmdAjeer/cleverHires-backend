...
const {uploadPost,getAllPosts,likePost,addComment,deletePost,getAllUsers, followUser,unFollowUser, addExperience , getProfile} = require('../controller/userController')
